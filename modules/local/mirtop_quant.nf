process MIRTOP_QUANT {
    ...
    conda 'mirtop=0.4.25 conda-forge::pandas=1.4.2 conda-forge::biopython=1.79 bioconda::samtools=1.15.1 conda-forge::r-base=4.1.1 conda-forge::r-data.table=1.14.2'
